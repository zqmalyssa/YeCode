...
public class Edge {
  ...
  private Node firstVexPosition; //边的第一个顶点与第二个顶点
  private Node secondVexPosition; //在顶点表中的位置
  private Node edgeFirstPosition; //边在第一（二）顶点的邻接（逆邻接）边表的位置
  ...
  public void setEdgeSecondPosition(
      Node edgeSecondPosition) {
